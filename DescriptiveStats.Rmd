...
vignette:   %\VignetteIndexEntry{Introduction DescriptiveStats.OBeu} %\VignetteEngine{knitr::rmarkdown} \usepackage[utf8]{inputenc}
---
...
```
```{r}
descript= open_spending.ds(Wuppertal_openspending, dimensions ="functional_classification_3.Produktgruppe|date_2.Year",
                 amounts = "Amount")
