...
## Output
The output of this process is a list in json format divided into four components of parameters and results with the first subcomponents (for further details go on [TimeSeries.OBeu](https://github.com/okgreece/TimeSeries.OBeu/blob/master/R/ts.analysis.R))
